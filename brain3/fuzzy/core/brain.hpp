...
#include "crisp/core/symbolic.hpp"
#include "crisp/core/scratchpad.hpp"
#include "crisp/core/reasoning.hpp"
// Brain V3 additions
#include "predictive_coding.hpp"
#include "binding_memory.hpp"
#include "global_workspace.hpp"
#include "basal_ganglia.hpp"
#include "crisp/core/procedural_memory.hpp"
#include "hierarchical_predictor.hpp"
#include "analogy.hpp"
#include "crisp/core/logic_engine.hpp"
#include "crisp/core/policy_engine.hpp"
...
public:
    ...
    brain2::reasoning::ReasoningEngine brainql_engine; // Native BrainQL Support
    brain2::math::MathEngine           math_engine;     // Unified Math & Physics Engine
    brain2::CodeEngine                 code_engine;     // Program Synthesis & Code Engine
    brain2::reasoning::PolicyMemory    policy_memory;   // Means-Ends Planning Policy Memory
    brain3::engines::vision::VisionEngine vision_engine; // Native Visual Grounding Engine
    brain2::reasoning::CausalEngine    causal_engine;   // Native Pearl Causal & Counterfactual Engine
    brain2::reasoning::AnalogyEngine   analogy_engine;  // Native Structure-Mapping Analogy Engine
    brain2::reasoning::MetacognitiveEngine metacognitive_engine; // Native Dual-Process Refutation Engine
    brain2::discovery::DiscoveryEngine discovery_engine; // Native Scientific Law & Symbolic Regression Engine
    brain2::reasoning::CuriosityEngine curiosity_engine; // Native Autonomous Curiosity & Self-Directed Discovery Engine
    brain2::reasoning::InstinctEngine  instinct_engine;  // Native Human Instinct & Evolving Reflex Engine
...
public:
    ...
    // Master Sleep Consolidation Cycle (Phases 1-4)
    brain2::reasoning::SleepReport sleep(const std::string& gate_log = "associative_gate.jsonl",
                                        const std::string& checkpoint_dir = "./out/brain_fluent") {
        brain2::reasoning::SleepEngine sleep_engine;
        return sleep_engine.full_sleep(*this, gate_log, checkpoint_dir);
    }
