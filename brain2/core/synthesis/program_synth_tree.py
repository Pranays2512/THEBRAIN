...
from core.synthesis.program_synth_guided import OPS, run, features, rand_name, rand_program, make_hard_tasks
from core.synthesis.program_synth_policy import learn_policy, policy_scores as linear_scores, PolicySynth
...
def main():
    ...
    for ex, _ in tasks:
        from core.synthesis.program_synth_guided import Synthesize
