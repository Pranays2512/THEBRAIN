"""
M54 BREAK TEST SUITE  (fixed from M51 version)
===============================================
...
SUBSTANTIVE CHANGES:
  - All tests now import CortexM53 instead of CortexM51.
...
try:
    ...
    from m54_cortex import (
        CortexM54 as CortexM51,   # drop-in alias — M52 is the fixed M51
        prepare_input,
...
print(f"  Target: dead < 15%  (M54 fix: SIGMA_MIN=1.5 + conscience(0.5))")
